...
public class Steps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("user").child(user.getUid()).child("readings").child("Steps").child("values");
    ...
    private void LoadPreference(){
        ...
        Steps.add(convertTimestamp(mtimestamp)+ ":   "  +mread);

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1,Steps) {
            @NonNull
            @Override
